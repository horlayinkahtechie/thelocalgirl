    ...
    <div className="w-full py-16 bg-gradient-to-b from-white to-amber-50">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {showLeftArrow && (
          <button
            onClick={() => scroll("left")}
            className="hidden lg:flex absolute -left-4 top-1/2 transform -translate-y-1/2 z-10 bg-white/90 hover:bg-white text-gray-800 hover:text-amber-500 w-12 h-12 rounded-full shadow-lg border border-gray-200 items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl"
        ...
        {showRightArrow && (
          <button
            ...
            className="hidden lg:flex absolute -right-4 top-1/2 transform -translate-y-1/2 z-10 bg-white/90 hover:bg-white text-gray-800 hover:text-amber-500 w-12 h-12 rounded-full shadow-lg border border-gray-200 items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl"
        ...
        <div className="lg:hidden flex justify-center gap-3 mt-8">
          <button
            onClick={() => scroll("left")}
            className="bg-gray-800 hover:bg-gray-900 text-white w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 shadow-lg"
            aria-label="Scroll left"
          >
            <ArrowLeft size={18} />
          </button>
      ...
      <div className="text-center mt-12">
        <Link
          href="/collections"
          className="inline-flex items-center gap-3 bg-gradient-to-r from-amber-500 to-rose-500 text-white font-bold py-4 px-8 rounded-full hover:from-amber-600 hover:to-rose-600 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
        >
